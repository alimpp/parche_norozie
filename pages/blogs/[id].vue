      ...
      <div class="header" data-aos="fade-down">
        ...
        <div class="header-info">
          <div class="app-flex app-flex-column app-mb-5">
            <h1 class="app-font-size-18 app-font-weight-600">
              {{ dataSource.title }}
            </h1>
          ...
          <div class="app-flex app-px-2">
            <span class="app-font-size-12">{{ $t("autor") }} :</span>
            <span class="app-font-size-12 app-px-2">علیرضا نوروزی</span>
          </div>
          <div class="share-link-content app-border-radius">
            <span class="app-pt-2" @click="copyLink">
              <CopyIcon size="1.5x"></CopyIcon>
            </span>
            <span class="app-font-size-12 app-w-100 app-flex app-justify-end">
      ...
      <div class="content">
        ...
        <div class="app-w-100 app-flex app-flex-column">
          <div class="app-flex">
            ...
            <span class="app-font-size-18 app-font-weight-600 app-px-2">{{
              $t("labels")
            }}</span>
          </div>
